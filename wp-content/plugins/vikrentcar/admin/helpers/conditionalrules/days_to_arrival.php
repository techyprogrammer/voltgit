...
class VikRentCarConditionalRuleDaysToArrival extends VikRentCarConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::translate('VRC_CONDTEXT_RULE_DTA');
		$this->ruleDescr = JText::translate('VRC_CONDTEXT_RULE_DTA_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vrc-param-container">
			<div class="vrc-param-label"><?php echo JText::translate('VRDAYS'); ?></div>
