...
class VikRentCarConditionalRuleRentalDates extends VikRentCarConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::translate('VRCTRKBOOKINGDATES');
		$this->ruleDescr = JText::translate('VRC_CONDTEXT_RULE_RENTDATES_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vrc-param-container">
			<div class="vrc-param-label"><?php echo JText::translate('VRNEWRESTRICTIONDFROMRANGE'); ?></div>
		...
		<div class="vrc-param-container">
			<div class="vrc-param-label"><?php echo JText::translate('VRNEWRESTRICTIONDTORANGE'); ?></div>
			<div class="vrc-param-setting">
