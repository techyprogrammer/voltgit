...
class VikRentCarAdminWidgetStickyNotes extends VikRentCarAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::translate('VRC_W_STICKYN_TITLE');
		$this->widgetDescr = JText::translate('VRC_W_STICKYN_DESCR');
	...
	public function render($data = null)
	{
		...
		<div class="vrc-admin-widget-wrapper">
			<div class="vrc-admin-widget-head">
				<h4><?php VikRentCarIcons::e('thumbtack'); ?> <?php echo JText::translate('VRC_W_STICKYN_TITLE'); ?></h4>
				<div class="btn-toolbar pull-right vrc-btn-toolbar-hastext">
					<span class="vrc-sticky-shortcuts-help"<?php echo count($instance_settings) ? ' style="display: none;"' : ''; ?>>
						...
						echo $this->vrc_app->createPopover(array(
							'title' => JText::translate('VRC_W_STICKYN_HELP_TITLE'),
							'content' => JText::translate(($this->isMac ? 'VRC_W_STICKYN_HELP_DESCR_MAC' : 'VRC_W_STICKYN_HELP_DESCR')),
