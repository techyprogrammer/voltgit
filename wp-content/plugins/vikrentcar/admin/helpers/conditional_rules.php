...
class VikRentCarHelperConditionalRules
{
	...
	{
		return [
			'email_tmpl.php' 		=> JText::translate('VRCONFIGEMAILTEMPLATE'),
			'pdf_tmpl.php' 			=> JText::translate('VRCONFIGPDFTEMPLATE'),
			'checkin_pdf_tmpl.php' 	=> JText::translate('VRCONFIGPDFCHECKINTEMPLATE'),
			'invoice_tmpl.php' 	   	=> JText::translate('VRCONFIGPDFINVOICETEMPLATE'),
		];
	}
