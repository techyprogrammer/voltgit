...
jQuery(function($){'."\n".'
	$.datepicker.regional["vikrentcar"] = {'."\n".'
		...
		monthNamesShort: ["'.$this->safeSubstr(JText::translate('VRMONTHONE')).'","'.$this->safeSubstr(JText::translate('VRMONTHTWO')).'","'.$this->safeSubstr(JText::translate('VRMONTHTHREE')).'","'.$this->safeSubstr(JText::translate('VRMONTHFOUR')).'","'.$this->safeSubstr(JText::translate('VRMONTHFIVE')).'","'.$this->safeSubstr(JText::translate('VRMONTHSIX')).'","'.$this->safeSubstr(JText::translate('VRMONTHSEVEN')).'","'.$this->safeSubstr(JText::translate('VRMONTHEIGHT')).'","'.$this->safeSubstr(JText::translate('VRMONTHNINE')).'","'.$this->safeSubstr(JText::translate('VRMONTHTEN')).'","'.$this->safeSubstr(JText::translate('VRMONTHELEVEN')).'","'.$this->safeSubstr(JText::translate('VRMONTHTWELVE')).'"],'."\n".'
		dayNames: ["'.JText::translate('VRWEEKDAYZERO').'", "'.JText::translate('VRWEEKDAYONE').'", "'.JText::translate('VRWEEKDAYTWO').'", "'.JText::translate('VRWEEKDAYTHREE').'", "'.JText::translate('VRWEEKDAYFOUR').'", "'.JText::translate('VRWEEKDAYFIVE').'", "'.JText::translate('VRWEEKDAYSIX').'"],'."\n".'
		dayNamesShort: ["'.$this->safeSubstr(JText::translate('VRWEEKDAYZERO')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYONE')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYTWO')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYTHREE')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYFOUR')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYFIVE')).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYSIX')).'"],'."\n".'
		dayNamesMin: ["'.$this->safeSubstr(JText::translate('VRWEEKDAYZERO'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYONE'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYTWO'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYTHREE'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYFOUR'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYFIVE'), 2).'", "'.$this->safeSubstr(JText::translate('VRWEEKDAYSIX'), 2).'"],'."\n".'
	...
	public function loadVisualEditorAssets()
	{
		...
		$doc->addStyleDeclaration('
			...
			.ql-picker.ql-specialtags .ql-picker-label:before {
				content: "' . htmlspecialchars(JText::translate('VRC_CONDTEXT_TKN')) . '";
			}
		' . $css_font_decl);
		...
		$mail_wrapper_icn = '<i class="' . VikRentCarIcons::i('minus-square') . '" title="' . htmlspecialchars(JText::translate('VRC_INSERT_CONT_WRAPPER')) . '"></i>';

		// icon for mail preview
		$mail_preview_icn = '<i class="' . VikRentCarIcons::i('eye') . '" title="' . htmlspecialchars(JText::translate('VRCPREVIEW')) . '"></i>';

		// icon for property logo (home icon)
		$mail_homelogo_icn = '<i class="' . VikRentCarIcons::i('car') . '" title="' . htmlspecialchars(JText::translate('VRCONFIGFOURLOGO')) . '"></i>';
...
JS
	...
	public function renderVisualEditor($name, $value, $attrs = array(), $opts = array(), $btns = array())
	{
		...
		$text_html_lbl 	 = JText::translate('VRC_MODE_TEXTHTML');
		$visual_mode_lbl = JText::translate('VRC_MODE_VISUAL');
