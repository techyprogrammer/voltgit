...
class VikRentCarViewPlaces extends JViewVikRentCar {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::translate('VRMAINPLACETITLE'), 'vikrentcar');
		if (JFactory::getUser()->authorise('core.create', 'com_vikrentcar')) {
			JToolBarHelper::addNew('newplace', JText::translate('VRMAINPLACENEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentcar')) {
			JToolBarHelper::editList('editplace', JText::translate('VRMAINPLACEEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentcar')) {
			JToolBarHelper::deleteList(JText::translate('VRCDELCONFIRM'), 'removeplace', JText::translate('VRMAINPLACEDEL'));
			JToolBarHelper::spacer();
		}
	}
