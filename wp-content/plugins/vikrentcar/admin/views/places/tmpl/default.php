...
<div class="table-responsive">
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vrc-list-table">
		...
		<tr>
			...
			<th class="title left" width="150"><?php echo JText::translate( 'VRCLOCADDRESS' ); ?></th>
			<th class="title center" width="100" align="center"><?php echo JText::translate( 'VRCPLACELAT' ); ?></th>
			<th class="title center" width="100" align="center"><?php echo JText::translate( 'VRCPLACELNG' ); ?></th>
			<th class="title left" width="150"><?php echo JText::translate( 'VRCPLACEDESCR' ); ?></th>
			<th class="title center" width="150" align="center"><?php echo JText::translate( 'VRCPLACEOPENTIME' ); ?></th>
			<th class="title center" width="100" align="center"><?php echo JText::translate( 'VRCORDERING' ); ?></th>
		</tr>
		</thead>
	<?php
