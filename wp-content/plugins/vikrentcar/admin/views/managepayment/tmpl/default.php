...
function vikLoadPaymentParameters(pfile) {
	if (pfile.length > 0) {
		jQuery("#vikparameters").html('<p><?php echo addslashes(JText::translate('VIKLOADING')); ?></p>');
		jQuery.ajax({
			type: "POST",
...
<form name="adminForm" id="adminForm" action="index.php" method="post">
	<div class="vrc-admin-container">
		<div class="vrc-config-maintab-left">
				...
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTONE'); ?></div>
							<div class="vrc-param-setting"><input type="text" name="name" value="<?php echo count($row) ? htmlspecialchars($row['name']) : ''; ?>" size="30"/></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTTWO'); ?></div>
							<div class="vrc-param-setting"><?php echo $psel; ?></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTTHREE'); ?></div>
							<div class="vrc-param-setting"><?php echo $vrc_app->printYesNoButtons('published', JText::translate('VRYES'), JText::translate('VRNO'), (count($row) ? (int)$row['published'] : 1), 1, 0); ?></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTCHARGEORDISC'); ?></div>
							<div class="vrc-param-setting">
								<select name="ch_disc">
									<option value="1"<?php echo (count($row) && $row['ch_disc'] == 1 ? " selected=\"selected\"" : ""); ?>><?php echo JText::translate('VRNEWPAYMENTCHARGEPLUS'); ?></option>
									<option value="2"<?php echo (count($row) && $row['ch_disc'] == 2 ? " selected=\"selected\"" : ""); ?>><?php echo JText::translate('VRNEWPAYMENTDISCMINUS'); ?></option>
			...
			<fieldset class="adminform">
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo $vrc_app->createPopover(array('title' => JText::translate('VRCPAYMENTSHELPCONFIRMTXT'), 'content' => JText::translate('VRCPAYMENTSHELPCONFIRM'))); ?> <?php echo JText::translate('VRNEWPAYMENTEIGHT'); ?></div>
							<div class="vrc-param-setting"><?php echo $vrc_app->printYesNoButtons('setconfirmed', JText::translate('VRYES'), JText::translate('VRNO'), (count($row) ? (int)$row['setconfirmed'] : 0), 1, 0); ?></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTNINE'); ?></div>
							<div class="vrc-param-setting"><?php echo $vrc_app->printYesNoButtons('shownotealw', JText::translate('VRYES'), JText::translate('VRNO'), (count($row) ? (int)$row['shownotealw'] : 0), 1, 0); ?></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRC_PAYBUT_POS'); ?></div>
							<div class="vrc-param-setting">
								<select id="vrc-outposition" name="outposition" onchange="vrcUpdateOutposSkeleton();">
									<option value="top"<?php echo !count($row) || (count($row) && $row['outposition'] == 'top') ? ' selected="selected"' : ''; ?>><?php echo JText::translate('VRC_PAYBUT_POS_TOP'); ?></option>
									<option value="middle"<?php echo count($row) && $row['outposition'] == 'middle' ? ' selected="selected"' : ''; ?>><?php echo JText::translate('VRC_PAYBUT_POS_MIDDLE'); ?></option>
									<option value="bottom"<?php echo count($row) && $row['outposition'] == 'bottom' ? ' selected="selected"' : ''; ?>><?php echo JText::translate('VRC_PAYBUT_POS_BOTTOM'); ?></option>
								</select>
								<?php
						...
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRC_PAYMET_LOGO'); ?></div>
							<div class="vrc-param-setting"><?php echo $vrc_app->getMediaField('logo', (count($row) && !empty($row['logo']) ? $row['logo'] : null)); ?></div>
						</div>
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRNEWPAYMENTFIVE'); ?></div>
							<div class="vrc-param-setting">
								<?php
		...
		<div class="vrc-config-maintab-right">
			<fieldset class="adminform">
				<div class="vrc-params-wrap">
					<legend class="adminlegend"><?php echo JText::translate('VRPAYMENTPARAMETERS'); ?></legend>
