	...
	<div class="vrc-admin-container">
		<div class="vrc-config-maintab-left vrc-config-maintab-left-halfsize">
			<fieldset class="adminform">
				<div class="vrc-params-wrap">
					...
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							<div class="vrc-param-label"><?php echo JText::translate('VRC_CONDTEXT_TKN'); ?></div>
							<div class="vrc-param-setting">
								...
								<span class="vrc-param-setting-comment"><?php echo JText::translate('VRC_CONDTEXT_TKN_HELP'); ?></span>
							</div>
						</div>
					</div>
					<div class="vrc-param-container">
						<div class="vrc-param-label"><?php echo JText::translate('VRC_CONDTEXT_DEBUG_RULES'); ?></div>
						<div class="vrc-param-setting">
							<?php echo $vrc_app->printYesNoButtons('debug', JText::translate('VRYES'), JText::translate('VRNO'), (count($this->condtext) ? (int)$this->condtext['debug'] : 0), 1, 0); ?>
							<span class="vrc-param-setting-comment"><?php echo JText::translate('VRC_CONDTEXT_DEBUG_RULES_HELP'); ?></span>
						</div>
					</div>
					<div class="vrc-param-container vrc-param-container-full">
						<div class="vrc-param-label vrc-param-label-above"><?php echo JText::translate('VRC_CONDTEXT_MSG'); ?></div>
						<div class="vrc-param-setting">
							<?php
							...
							?>
							<span class="vrc-param-setting-comment"><?php echo JText::translate('VRC_CONDTEXT_MSG_HELP'); ?></span>
						</div>
					</div>
					<div class="vrc-params-container">
						<div class="vrc-param-container">
							<div class="vrc-param-setting">
								<p id="vrc-condtext-warn-norules" class="warn notice-noicon"<?php echo count($cond_text_rules) ? ' style="display: none;"' : ''; ?>><?php VikRentCarIcons::e('info-circle'); ?> <?php echo JText::translate('VRC_CONDTEXT_WARN_NORULES'); ?></p>
								<button type="button" class="btn vrc-config-btn" onclick="vrcAddNewRule();"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_CONDTEXT_ADDRULE'); ?></button>
							</div>
						</div>
					</div>
				</div>
		...
		?>
			<div class="vrc-condtext-addrule-helper">
				<p id="vrc-condtext-warn-norules-scnd" class="warn notice-noicon"<?php echo count($cond_text_rules) ? ' style="display: none;"' : ''; ?>><?php VikRentCarIcons::e('info-circle'); ?> <?php echo JText::translate('VRC_CONDTEXT_WARN_NORULES'); ?></p>
				<button id="vrc-condtext-addrule-scnd" type="button" class="btn vrc-config-btn" onclick="vrcAddNewRule();"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_CONDTEXT_ADDRULE'); ?></button>
			</div>
		</div>
...
<div class="vrc-modal-overlay-block vrc-modal-overlay-block-condtext">
	...
	<div class="vrc-modal-overlay-content vrc-modal-overlay-content-tall vrc-modal-overlay-content-condtext">
		<div class="vrc-modal-overlay-content-head vrc-modal-overlay-content-head-condtext">
			<h3><span><?php echo JText::translate('VRC_CONDTEXT_ADDRULE'); ?></span> <span class="vrc-modal-overlay-close-times" onclick="hideVrcModalCondtext();">&times;</span></h3>
		</div>
		...
		<div class="vrc-modal-overlay-content-footer">
			<div class="vrc-modal-overlay-content-footer-right">
				<button type="button" class="btn btn-success" onclick="vrcAddRuleToDoc();"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_CONDTEXT_ADDRULE'); ?></button>
			</div>
		</div>
	</div>
</div>
