	...
	<div class="vikwppro-header">
		<div class="vikwppro-header-inner">
			<div class="vikwppro-download-result">
				<h2><?php VikRentCarIcons::e('refresh', 'fa-spin'); ?> <?php echo JText::translate('VRCPROPLWAIT'); ?></h2>
				<h3 class="vikwppro-cur-action"><?php echo JText::translate('VRCPRODLINGPKG'); ?></h3>
			</div>
