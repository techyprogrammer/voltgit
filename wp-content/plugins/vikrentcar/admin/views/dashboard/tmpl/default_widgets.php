	...
	<div class="vrc-admin-widgets-commands">
		<div class="vrc-admin-widgets-commands-info" data-vrcmanagewidgets="1" style="display: none;">
			<div class="vrc-admin-widgets-commands-info-inner">
				<span class="vrc-admin-widgets-commands-info-txt"><?php echo JText::translate('VRC_WIDGETS_AUTOSAVE'); ?></span>
				<div class="vrc-admin-widgets-commands-info-restore">
					<a href="index.php?option=com_vikrentcar&task=reset_admin_widgets" class="btn btn-secondary" onclick="return vrcWidgetsRestoreMap();"><?php echo JText::translate('VRC_WIDGETS_RESTDEFAULTSHORT'); ?></a>
				</div>
			</div>
		</div>
		<div class="vrc-admin-widgets-commands-mng">
			<span class="vrc-admin-widgets-commands-mng-toggle"><?php echo $vrc_app->printYesNoButtons('vrccustwidgets', JText::translate('VRYES'), JText::translate('VRNO'), 0, 1, 0, 'vrcWidgetsToggleManage(false);'); ?></span>
			<span class="vrc-admin-widgets-commands-mng-lbl" onclick="vrcWidgetsToggleManage(true);"><?php VikRentCarIcons::e('cogs'); ?> <?php echo JText::translate('VRC_WIDGETS_CUSTWIDGETS'); ?></span>
		</div>
	</div>
<?php
}
	...
	<div class="vrc-modal-overlay-content vrc-modal-overlay-content-dashwidgets">
		...
		<div class="vrc-modal-overlay-content-body vrc-modal-overlay-content-body-scroll">
			<div class="vrc-modal-widgets-newcontainer vrc-modal-widgets-forms" style="display: none;">
				<div class="vrc-modal-widgets-form-data-fields">
					<div class="vrc-modal-widgets-form-data-field">
						<label for="vrc-newcontainer-size"><?php echo JText::translate('VRC_WIDGETS_CONTSIZE'); ?></label>
					...
					<div class="vrc-modal-widgets-form-data-field vrc-modal-widgets-form-data-field-save">
						<button type="button" class="btn btn-success" id="vrc-newcontainer-btn" onclick="vrcWidgetsAddContainerToDoc();"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_WIDGETS_ADDWIDGCONT'); ?></button>
					</div>
				</div>
			</div>
			<div class="vrc-modal-widgets-newwidget vrc-modal-widgets-forms" style="display: none;">
				<div class="vrc-modal-widgets-form-data-fields">
					<div class="vrc-modal-widgets-form-data-field">
						<label for="vrc-newwidget-id"><?php echo JText::translate('VRC_WIDGETS_SELWIDGADD'); ?></label>
					...
					<div class="vrc-modal-widgets-form-data-field vrc-modal-widgets-form-data-field-save">
						<button type="button" class="btn btn-success" onclick="vrcWidgetsAddWidgetToDoc();"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_WIDGETS_ADDNEWWIDG'); ?></button>
					</div>
				</div>
			</div>
		<?php
		if ($widgets_welcome) {
			...
			<div class="vrc-widgets-welcome-wrap vrc-modal-widgets-forms" style="display: none;">
				<div class="vrc-widgets-welcome-inner">
					<p><?php echo JText::translate('VRC_WIDGETS_WELCOME_DESC1'); ?></p>
					<p><?php echo JText::translate('VRC_WIDGETS_WELCOME_DESC2'); ?></p>
					<div class="vrc-widgets-welcome-demo">
						<div class="vrc-widgets-welcome-demo-section">
							<span class="vrc-widgets-welcome-demo-section-lbl"><?php echo JText::translate('VRC_WIDGETS_NEWSECT'); ?></span>
							<div class="vrc-widgets-welcome-demo-container">
								<span class="vrc-widgets-welcome-demo-container-lbl"><?php echo JText::translate('VRC_WIDGETS_ADDWIDGCONT'); ?></span>
								<div class="vrc-widgets-welcome-demo-widget">
									<span class="vrc-widgets-welcome-demo-widget-lbl"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_WIDGETS_ADDNEWWIDG'); ?></span>
								</div>
							</div>
							<div class="vrc-widgets-welcome-demo-container">
								<span class="vrc-widgets-welcome-demo-container-lbl"><?php echo JText::translate('VRC_WIDGETS_ADDWIDGCONT'); ?></span>
					...
					<div class="vrc-widgets-welcome-actions">
						<div class="vrc-widgets-welcome-action">
							<button type="button" class="btn btn-success" onclick="vrcWidgetsCloseWelcome(0);"><?php echo JText::translate('VRCBTNKEEPREMIND'); ?></button>
						</div>
						<div class="vrc-widgets-welcome-action">
							<button type="button" class="btn btn-secondary" onclick="vrcWidgetsCloseWelcome(1);"><?php echo JText::translate('VRCBTNDONTREMIND'); ?></button>
						</div>
					</div>
				</div>
			</div>
