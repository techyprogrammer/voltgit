...
if (empty($fpath) || $fp === false) {
	?>
	<p class="err"><?php echo JText::translate('VRCTMPLFILENOTREAD'); ?></p>
	<?php
} else {
	while (!feof($fp)) {
		$fcode .= fread($fp, 8192);
...
<form name="adminForm" id="adminForm" action="index.php" method="post">
	<fieldset class="adminform">
		<legend class="adminlegend"><?php echo JText::translate('VRCEDITTMPLFILE'); ?></legend>
		...
		<p style="text-align: center;">
			<button type="button" class="btn btn-success" onclick="vrcSubmitTmplFile(this);"><?php echo JText::translate('VRCSAVETMPLFILE'); ?></button>
		</p>
	</fieldset>
	<input type="hidden" name="path" value="<?php echo JHtml::fetch('esc_attr', $fpath); ?>">
