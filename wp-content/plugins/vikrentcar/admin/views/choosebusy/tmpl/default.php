...
<div class="vrc-choosebusy-head">
	...
	<div class="vrc-choosebusy-head-bottom">
		<div class="vrc-choosebusy-unitsav">
			<span class="vrc-choosebusy-unitsav-txt"><?php echo JText::translate('VRPCHOOSEBUSYCAVAIL'); ?>:</span>
...
<div class="table-responsive">
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vrc-list-table">
		<thead>
		<tr>
			<th class="title left" width="50"><?php echo JText::translate( 'VRCORDERNUMBER' ); ?></th>
			...
			<th class="title center" width="150"><?php echo JText::translate( 'VRCUNITASSIGNED' ); ?></th>
			...
			if (is_array($car_params) && count($car_params['features'])) {
				foreach ($car_params['features'] as $cind => $cfeatures) {
					...
					foreach ($cfeatures as $fname => $fval) {
						if (strlen($fval)) {
							$car_first_feature = '#'.$cind.' - '.JText::translate($fname).': '.$fval;
							break 2;
						}
					}
				}
	...
	<input type="hidden" name="ts" value="<?php echo JHtml::fetch('esc_attr', $pts); ?>" />
