				...
				<dt class="tabs <?php echo $this->curtabid == 1 ? 'open' : 'closed'; ?>" data-ptid="1" style="cursor: pointer;">
					...
					<span>
						<h3>
							...
							<a href="javascript:void(0);"><?php echo JText::translate('VRC_COND_TEXTS'); ?></a>
						</h3>
					</span>
				</dt>
				<dt class="vrc-renewsession-dt">
					<a href="javascript: void(0);" class="vrcflushsession" onclick="vrcFlushSession();"><?php echo JText::translate('VRCONFIGFLUSHSESSION'); ?></a>
				</dt>
			</dl>
...
function vrcFlushSession() {
	if (confirm('<?php echo addslashes(JText::translate('VRCONFIGFLUSHSESSIONCONF')); ?>')) {
