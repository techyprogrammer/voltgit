...
<div class="vrc-config-maintab-top">
	<fieldset class="adminform vrc-config-fieldset-large">
		<div class="vrc-params-wrap">
			<legend class="adminlegend"><?php echo JText::translate('VRC_COND_TEXT_RULES'); ?></legend>
			<div class="vrc-params-container">
				<div class="vrc-param-container">
					<div class="vrc-param-setting">
						<a href="index.php?option=com_vikrentcar&task=newcondtext" class="btn vrc-config-btn"><?php VikRentCarIcons::e('plus-circle'); ?> <?php echo JText::translate('VRC_NEW_COND_TEXT'); ?></a>
					</div>
				</div>
				<div class="vrc-param-container">
					<div class="vrc-param-setting">
						<div class="table-responsive vrc-list-table-rounded">
							<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vrc-list-table">
								<thead>
									<tr>
										<th class="title left" width="200"><?php echo JText::translate('VRC_CONDTEXT_NAME'); ?></th>
										<th class="title left" width="200"><?php echo JText::translate('VRC_CONDTEXT_TKN'); ?></th>
										<th class="title center" width="100"><?php echo JText::translate('VRC_WIDGETS_LASTUPD'); ?></th>
										<th class="title center" width="300"><?php echo JText::translate('VRC_TEMPLATE_FILES'); ?></th>
							...
							for ($i = 0, $n = count($rows); $i < $n; $i++) {
								...
								<tr class="row<?php echo $k; ?>">
									...
									<td class="center">
										<a href="index.php?option=com_vikrentcar&amp;task=removecondtext&amp;cid[]=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm(Joomla.JText._('VRCDELCONFIRM'));"><?php VikRentCarIcons::e('trash'); ?> <?php echo JText::translate('VRCMAINCRONDEL'); ?></a>
									</td>
								</tr>	
								<?php
								$k = 1 - $k;
	...
	<fieldset class="adminform vrc-config-fieldset-small">
		<div class="vrc-params-wrap">
			<legend class="adminlegend"><?php echo JText::translate('VRCONFIGEDITTMPLFILE'); ?></legend>
			<div class="vrc-params-container">
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRCONFIGEMAILTEMPLATE'); ?></div>
					<div class="vrc-param-setting">
						<button type="button" class="btn vrc-inspector-btn" title="<?php echo addslashes(JText::translate('VRC_INSPECTOR_START')); ?>" data-inspectfile="email_tmpl.php"><?php VikRentCarIcons::e('paint-brush'); ?></button>
					</div>
				</div>
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRCONFIGPDFTEMPLATE'); ?></div>
					<div class="vrc-param-setting">
						<button type="button" class="btn vrc-inspector-btn" title="<?php echo addslashes(JText::translate('VRC_INSPECTOR_START')); ?>" data-inspectfile="pdf_tmpl.php"><?php VikRentCarIcons::e('paint-brush'); ?></button>
					</div>
				</div>
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRCONFIGPDFCHECKINTEMPLATE'); ?></div>
					<div class="vrc-param-setting">
						<button type="button" class="btn vrc-inspector-btn" title="<?php echo addslashes(JText::translate('VRC_INSPECTOR_START')); ?>" data-inspectfile="checkin_pdf_tmpl.php"><?php VikRentCarIcons::e('paint-brush'); ?></button>
					</div>
				</div>
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRCONFIGPDFINVOICETEMPLATE'); ?></div>
					<div class="vrc-param-setting">
						<button type="button" class="btn vrc-inspector-btn" title="<?php echo addslashes(JText::translate('VRC_INSPECTOR_START')); ?>" data-inspectfile="invoice_tmpl.php"><?php VikRentCarIcons::e('paint-brush'); ?></button>
					</div>
				</div>
				<div class="vrc-param-container">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_CONT_WRAPPER'); ?></div>
					<div class="vrc-param-setting">
				...
				<div class="vrc-param-container vrc-param-nested vrc-contwrapper-edit" style="display: none;">
					...
					?>
					<div class="vrc-param-setting">
						<textarea id="vrc-contwrapper-html" style="width: 100% !important; min-height: 250px;"><?php echo JHtml::fetch('esc_textarea', $cont_wrapper_opening . "\n\n\t\t--- " . JText::translate('VRC_TPL_TEXT') . " ---\n\n" . $cont_wrapper_closing); ?></textarea>
						<div class="vrc-param-setting-comment"><?php echo JText::translate('VRC_CONT_WRAPPER_HELP'); ?></div>
					</div>
				</div>
				<div class="vrc-param-container vrc-param-nested vrc-contwrapper-edit" style="display: none;">
					<div class="vrc-param-setting">
						<button id="vrc-contwrapper-save" type="button" class="btn btn-success"><?php VikRentCarIcons::e('save'); ?> <?php echo JText::translate('VRSAVE'); ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="vrc-params-wrap">
			...
			<div class="vrc-params-container">
				<div class="vrc-param-container">
					<div class="vrc-param-setting">
						<div class="vrc-inspector-cmds">
							<button id="vrc-inspector-save" type="button" class="btn btn-success" disabled><?php VikRentCarIcons::e('save'); ?> <?php echo JText::translate('VRSAVE'); ?></button>
							<button id="vrc-inspector-cancel" type="button" class="btn btn-secondary"><?php VikRentCarIcons::e('times'); ?> <?php echo JText::translate('VRANNULLA'); ?></button>
						</div>
					</div>
				</div>
				<div class="vrc-param-container">
				...
				<div class="vrc-param-container vrc-inspector-css-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_HTML_TAG'); ?></div>
					<div class="vrc-param-setting">
						<span id="vrc-inspector-css-tag" class="vrc-inspector-css-tag"></span>
					</div>
				</div>
				<div class="vrc-param-container vrc-inspector-css-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_CSS_FONTCOLOR'); ?></div>
					<div class="vrc-param-setting">
				...
				<div class="vrc-param-container vrc-inspector-css-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_CSS_BACKGCOLOR'); ?></div>
					<div class="vrc-param-setting">
						<span class="vrc-inspector-colorpicker-wrap">
				...
				<div class="vrc-param-container vrc-inspector-css-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_CSS_BORDER'); ?></div>
					<div class="vrc-param-setting vrc-toggle-small">
						<?php echo $vrc_app->printYesNoButtons('vrc-inspector-css-border', JText::translate('VRYES'), JText::translate('VRNO'), 0, 1, 0, 'vrcToggleCSSBorderParams();'); ?>
					</div>
				</div>
				<div class="vrc-param-container vrc-inspector-css-border-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_CSS_BORDERWIDTH'); ?> (px)</div>
					<div class="vrc-param-setting">
						<input type="number" min="0" id="vrc-inspector-css-borderwidth" value="0" />
					</div>
				</div>
				<div class="vrc-param-container vrc-inspector-css-border-param" style="display: none;">
					<div class="vrc-param-label"><?php echo JText::translate('VRC_INSP_CSS_BORDERCOLOR'); ?></div>
					<div class="vrc-param-setting">
						<span class="vrc-inspector-colorpicker-wrap">
