...
class VikRentCarViewCars extends JViewVikRentCar {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::translate('VRMAINDEAFULTTITLE'), 'vikrentcar');
		if (JFactory::getUser()->authorise('core.create', 'com_vikrentcar')) {
			JToolBarHelper::addNew('newcar', JText::translate('VRMAINDEFAULTNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentcar')) {
			JToolBarHelper::editList('editcar', JText::translate('VRMAINDEFAULTEDITC'));
			JToolBarHelper::spacer();
		...
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentcar')) {
			JToolBarHelper::deleteList(JText::translate('VRJSDELCAR') . '?', 'removecar', JText::translate('VRMAINDEFAULTDEL'));
			JToolBarHelper::spacer();
		}
	}
