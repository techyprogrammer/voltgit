...
class VikRentCarViewTrackings extends JViewVikRentCar {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::translate('VRCMAINTRACKINGSTITLE'), 'vikrentcar');
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentcar')) {
			JToolBarHelper::deleteList(JText::translate('VRCDELCONFIRM'), 'removetrackings', JText::translate('VRMAINPAYMENTSDEL'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentcar')) {
			JToolBarHelper::custom('modtracking', 'refresh', 'refresh', JText::translate('VRCTRKTGLPUBLISHED'), true, false);
			JToolBarHelper::spacer();
		}
