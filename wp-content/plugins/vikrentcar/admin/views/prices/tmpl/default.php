...
if (empty($rows)) {
	?>
	<p class="err"><?php echo JText::translate('VRNOPRICESFOUND'); ?></p>
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'removeprice') {
		if (confirm('<?php echo JText::translate('VRJSDELPRICES'); ?>')) {
...
<div class="table-responsive">
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vrc-list-table">
		...
		<tr>
			...
			<th class="title left" width="150"><?php echo JText::translate( 'VRPVIEWPRICESONE' ); ?></th>
			<th class="title left" width="150"><?php echo JText::translate( 'VRPVIEWPRICESTWO' ); ?></th>
			<th class="title left" width="75"><?php echo JText::translate( 'VRPVIEWPRICESTHREE' ); ?></th>
		</tr>
		</thead>
	<?php
