...
if (empty($rows)) {
	?>
	<p class="warn"><?php echo JText::translate('VRNOCATEGORIESFOUND'); ?></p>
...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'removecat') {
		if (confirm('<?php echo JText::translate('VRJSDELCATEGORIES'); ?> ?')) {
...
<div class="table-responsive">
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vrc-list-table">
		...
		<tr>
			...
			<th class="title left" width="150"><?php echo JText::translate( 'VRPVIEWCATEGORIESONE' ); ?></th>
			<th class="title left" width="150"><?php echo JText::translate( 'VRPVIEWCATEGORIESDESCR' ); ?></th>
			<th class="title center" width="60" align="center"><?php echo JText::translate( 'VRCORDERING' ); ?></th>
		</tr>
		</thead>
	<?php
