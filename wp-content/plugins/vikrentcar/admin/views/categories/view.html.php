...
class VikRentCarViewCategories extends JViewVikRentCar {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::translate('VRMAINCATTITLE'), 'vikrentcar');
		if (JFactory::getUser()->authorise('core.create', 'com_vikrentcar')) {
			JToolBarHelper::addNew('newcat', JText::translate('VRMAINCATNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikrentcar')) {
			JToolBarHelper::editList('editcat', JText::translate('VRMAINCATEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikrentcar')) {
			JToolBarHelper::deleteList(JText::translate('VRCDELCONFIRM'), 'removecat', JText::translate('VRMAINCATDEL'));
			JToolBarHelper::spacer();
		}
	}
