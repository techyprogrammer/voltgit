...
class VikRentCarBuilder
{
	...
	public static function setupAdminMenu()
	{
		...
		add_menu_page(
			JText::translate('COM_VIKRENTCAR'), 		// page title
			JText::translate('COM_VIKRENTCAR_MENU'), 	// menu title
	...
	public static function setupHtmlHelpers()
	{
		...
		JHtml::register('renderCalendar', function($data)
		{
			...
			JHtml::fetch('stylesheet', VRC_SITE_URI . 'resources/jquery-ui.min.css');
		...
		JHtml::register('system.js', function()
		{
			...
			if (!$loaded)
			{
				...
				JHtml::fetch('script', VRC_ADMIN_URI . 'resources/js/system.js');
				JHtml::fetch('stylesheet', VRC_ADMIN_URI . 'resources/css/system.css');
				...
				if (JFactory::getApplication()->isAdmin() || (class_exists('VikRentCar') && VikRentCar::loadBootstrap()))
				{
					 ...
					 * @since 	1.1.4
					 */
					JHtml::fetch('script', VRC_ADMIN_URI . 'resources/js/vikbootstrap.min.js');
					JHtml::fetch('stylesheet', VRC_ADMIN_URI . 'resources/css/bootstrap.lite.css');
				}
			}
		});
		...
		JHtml::register('select2', function()
		{
			 ...
			 * @since 1.2.5
			 */
			JHtml::fetch('script', VRC_ADMIN_URI . 'resources/select2.min.js');
			JHtml::fetch('stylesheet', VRC_ADMIN_URI . 'resources/select2.min.css');
		});
